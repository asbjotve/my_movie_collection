...
/**
 * website_template_example v17 – v16 sin toppmeny + "Mine filmer" hentet
 * live fra databasen (som v15), med mulighet for å bytte mellom
 * rutenett (cover-art-plassholder) og en enkel liste/tabell-visning
 * som kun viser tittel, original tittel, årstall og IMDb-id.
 *
 * Status: "Mine filmer" bruker ekte data fra databasen via api.php.
 * Øvrige menypunkter (Ønskeliste/Andre lister/Administrering) er
 * fortsatt hardkodet demo-/plassholderdata, uendret fra v16.
 *
 * ============================================================
