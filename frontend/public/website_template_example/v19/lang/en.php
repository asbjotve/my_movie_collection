...
return [
    'wte' => [
        ...
        'detail' => [
            ...
            'groups_manage_title'      => 'Movie groups',
            'groups_no_groups'         => 'Not part of any movie group yet.',
            'groups_add_label'         => 'Add to movie group',
            'groups_add_btn'           => 'Add',
            'groups_add_name_required' => 'You must provide a name for the movie group.',
            'groups_add_error_prefix'  => 'Failed to add to group: ',
            'groups_remove_btn_title'  => 'Remove this movie from this group',
            'groups_remove_confirm'    => 'Remove this movie from the group "%s"?',
            'groups_remove_error_prefix' => 'Failed to remove from group: ',
        ],
