...
<main>
  <section class="card">
    <div class="tabs">
      <button type="button" class="tab-btn <?= $activeTab === 'create' ? 'active' : '' ?>" data-tab="create">Opprett liste</button>
      <button type="button" class="tab-btn <?= $activeTab === 'add' ? 'active' : '' ?>" data-tab="add">Legg til element</button>
    </div>
    ...
    <div class="tab-panel <?= $activeTab === 'add' ? 'active' : '' ?>" id="tab-add">
      ...
      <p class="lead">Velg hvilken liste elementet skal legges til i, fyll ut informasjon og last opp et coverbilde. Bruk gjerne TMDB-søket for å fylle ut feltene automatisk.</p>
      ...
      <?php elseif (empty($availableLists)): ?>
        <div class="empty-hint">Det finnes ingen lister enda. Opprett en liste under fanen "Opprett liste" for å komme i gang.</div>
      <?php else: ?>
        <form method="post" enctype="multipart/form-data">
          ...
          <label>
            ...
            <select name="list_id" required>
              <option value="" disabled <?= empty($_POST['list_id']) ? 'selected' : '' ?>>Velg liste…</option>
