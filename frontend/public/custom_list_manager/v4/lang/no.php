...
return [
    'clm' => [
        ...
        'header' => [
            ...
            'tag'   => 'Opprett liste &amp; rediger elementer',
        ],
        ...
        'messages' => [
            ...
            'item_id_required'     => 'Fant ikke elementets ID.',
        ],
        ...
        'edit_tab' => [
            'heading'            => 'Rediger liste',
            'lead'               => 'Velg en liste for å se og redigere elementene i den direkte. Du kan også legge til nye elementer nederst - bruk gjerne TMDB- eller TVDB-søket for å fylle ut feltene automatisk.',
            'empty_hint'         => 'Det finnes ingen lister enda. Opprett en liste under fanen "Opprett liste" for å komme i gang.',
            'list_label'         => 'Liste',
            'add_new_heading'    => '+ Nytt element',

            'loading'            => 'Laster elementer…',
            'empty'              => 'Denne listen er tom enda.',
            'fetch_error_prefix' => 'Kunne ikke hente elementene: %s',
            'select_list_hint'   => 'Velg en liste over for å se elementene i den.',
            ...
            'confirm_delete'     => 'Er du sikker på at du vil slette "%s" fra listen?',
            'deleting'           => 'Sletter…',
            'delete_error_prefix' => 'Kunne ikke slette: %s',

            'add_title_required' => 'Du må skrive inn en tittel.',
            'add_saving'         => 'Legger til…',
            'add_error_prefix'   => 'Kunne ikke legge til: %s',
        ],
