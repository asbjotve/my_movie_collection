...
return [
    'clm' => [
        ...
        'messages' => [
            ...
            'item_id_required'     => 'Could not find the item ID.',
        ],
        ...
        'edit_tab' => [
            'heading'            => 'Edit list',
            'lead'               => 'Select a list to view and edit its items directly. You can also add new items at the bottom - feel free to use the TMDB or TVDB search to auto-fill the fields.',
            'empty_hint'         => 'No lists exist yet. Create a list under the "Create list" tab to get started.',
            'list_label'         => 'List',
            'add_new_heading'    => '+ New item',

            'loading'            => 'Loading items…',
            'empty'              => 'This list is empty so far.',
            'fetch_error_prefix' => 'Could not fetch the items: %s',
            'select_list_hint'   => 'Select a list above to see its items.',
            ...
            'confirm_delete'     => 'Are you sure you want to delete "%s" from the list?',
            'deleting'           => 'Deleting…',
            'delete_error_prefix' => 'Could not delete: %s',

            'add_title_required' => 'You must enter a title.',
            'add_saving'         => 'Adding…',
            'add_error_prefix'   => 'Could not add: %s',
        ],
