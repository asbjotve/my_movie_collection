...
<body class="bg-light">
    ...
    <div class="tab-content border border-top-0 bg-white p-3 rounded-bottom">
      ...
      <div class="tab-pane fade show active" id="single" role="tabpanel" aria-labelledby="single-tab">
          ...
          <table class="table table-sm align-middle" id="singleTable">
            <thead class="table-light">
              <tr>
                ...
                <th style="width: 210px;">Discs (feature/bonus)</th>
        ...
        <div class="alert alert-info">
          Click <strong>Discs</strong> to add feature/bonus discs for a single release, and edit bonus-items per bonus disc.
        </div>
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="alert alert-warning py-2 d-none" id="bonusNotBonusAlert">
              This disc is not marked as <span class="mono">bonus</span>. You can still add items, but it might be inconsistent.
            </div>
  ...
  <script>
    ...
    let bonusTarget = null; // { type: 'single-disc-editor-row'|'box-disc-row', node: <tr>, discTypeGetter: fn }
    ...
    let discModalTargetSingleRow = null; // <tr> in singles table
    ...
    function openDiscModalForSingleRow(singleRow) {
      ...
      if (!existingDiscs || existingDiscs.length === 0) {
        // Start with one feature disc row by default
    ...
    function updateBoxDiscBonusButtonLabel(discRow) {
    ...
    function addDiscRowBox(boxSetRoot, {typeDisc="feature", format="BD", relatedTitle=""} = {}) {
      ...
      tbody.appendChild(row);
      updateBoxDiscBonusButtonLabel(row);
    }
