...
<body class="bg-light">
  <div class="container py-4">
    ...
    <div class="collapse mb-3" id="help">
      <div class="card card-body">
        <ul class="mb-0">
          <li><strong>Single releases</strong>: add many products; each can have multiple discs.</li>
          <li><strong>Box sets</strong>: add multiple box sets; each box has ordered movies and discs; discs can have bonus items.</li>
          <li><strong>Nested modals</strong>: when Bonus-items is open, the Discs modal becomes temporarily disabled to prevent misclicks.</li>
        </ul>
      </div>
    </div>
      ...
      <div class="tab-pane fade show active" id="single" role="tabpanel" aria-labelledby="single-tab">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
          ...
          <div class="d-flex gap-2">
            ...
            <button class="btn btn-sm btn-outline-secondary" type="button" id="btnSinglePreview">Preview singles</button>
            <button class="btn btn-sm btn-success" type="button" disabled>Submit singles</button>
          </div>
        </div>
        ...
        <div class="alert alert-info">
          Use <strong>Discs</strong> to add feature/bonus discs and edit bonus tracks per disc.
        </div>
      </div>
      ...
      <div class="tab-pane fade" id="box" role="tabpanel" aria-labelledby="box-tab">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          <div>
            ...
            <div class="text-muted small">Add multiple box sets, then preview all at once.</div>
          </div>
          <div class="d-flex gap-2">
            ...
            <button class="btn btn-success" type="button" disabled>Submit all box sets</button>
          </div>
        </div>
  ...
  <script>
    ...
    function addBoxTitleRow(boxSetRoot, {title="", imdb="", innerEan="", treatAsSingle=null} = {}) {
      ...
      titleInput.addEventListener('input', () => refreshBoxRelatedDropdown(boxSetRoot));
    ...
    function addBoxDiscRow(boxSetRoot, {typeDisc="feature", format="BD", relatedTitle=""} = {}) {
