...
<head>
  ...
  <style>
    ...
    /* Make the "Discs for single release" modal visually distinct (gray) */
    ...
    #discModal .modal-content { border: 1px solid rgba(0,0,0,.15); }

    /* Slightly de-emphasize the primary action in disc modal */
