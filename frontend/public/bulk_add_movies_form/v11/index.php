...
<body class="bg-light">
  ...
  <script>
    ...
    function addBoxDiscRow(boxSetRoot, {typeDisc="feature", format="BD", relatedIndex="", relatedTitle="", bonus_items=[]} = {}) {
      const tbody = boxSetRoot.querySelector('tbody[data-role="discs"]');
      ...
      row.querySelector('button[data-action="edit-bonus"]').addEventListener('click', () => {
        ...
        const subtitle = fmt('subtitle.box_disc', {n: currentOrder, discType, discFormat, rel: rel || fmt('word.whole_box_plain')});
