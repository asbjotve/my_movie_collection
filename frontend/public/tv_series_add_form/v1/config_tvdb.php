...
/**
 * config_tvdb.php - TVDB-oppsett for tv_series_add_form v1.
 *
 * Kopi av frontend/public/bulk_add_movies_form/v14/config_tvdb.php
 * (samme token-cache-fil i /tmp, siden det er samme TVDB-konto - da
 * slipper vi doble innlogginger på tvers av funksjonene i appen).
 */
