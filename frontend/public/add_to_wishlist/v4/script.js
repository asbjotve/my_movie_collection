// TMDB search modal script for add_to_wishlist (v4)
// - Uses PHP backend: api.php (samme mønster som bulk_add_movies_form)
// - Skriver resultatet direkte inn i wishlist-skjemaets felter:
